...
const Header = () => {
    return (
        <div id="home" className="header">
            ...
            <p>I'm a second year student at Ramdeobaba College of Engineering and Management, Nagpur. I'm an AIML enthusiast and I like to <span className="code">Code</span></p>
